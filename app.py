...
# يقرأ التوكن من متغير البيئة HF_TOKEN (أنت أضفته في Render)
HF_TOKEN = os.environ.get("HF_TOKEN")
if not HF_TOKEN:
    raise RuntimeError("⚠️ لم يتم العثور على متغير HF_TOKEN، أضفه في إعدادات Render.")

# رابط النموذج Mistral 7B
MODEL_URL = "https://api-inference.huggingface.co/models/mistralai/Mistral-7B-Instruct-v0.2"

@app.route("/")
def home():
    return "🚀 TBot AI Proxy is running successfully!"
...
TBot:"""
    ...
    payload = {"inputs": prompt, "parameters": {"max_new_tokens": 300, "temperature": 0.8}}
